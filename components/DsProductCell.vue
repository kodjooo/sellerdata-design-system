<template>
    ...
    <span class="ds-product-cell">
        ...
        <span class="ds-product-cell__body">
            ...
            <span v-if="sub || $slots.sub" class="t-caption ds-product-cell__sub">
...
.ds-product-cell__body { display: inline-flex; flex-direction: column; min-width: 0; }
.ds-product-cell__name { color: var(--text-heading); white-space: normal; }
.ds-product-cell__sub { color: var(--text-muted); }
</style>
